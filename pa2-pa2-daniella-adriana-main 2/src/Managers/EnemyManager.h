...
class EnemyManager {
    ...
    public:
        ...
        static void removeEnemiesOnlyCleanUp();
        static void removeEnemiesOnly();
    ...
    //==================== Helper Functions ====================
        ...
        static void decrementShieldBarTimer();
        static int getShieldBar();
        static void resetShieldBarTimer(int value);
        static int whichSpawnInterval(int playerScore); // Determines the interval for spawning enemies based on player score
        static void damageBosses(int damage);
        static bool changeShip;
