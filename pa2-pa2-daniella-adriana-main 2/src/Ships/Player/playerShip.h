...
class Player{ 
    ...
    private:
        ofImage shipSprite;
        ofImage shipSprite2;                 // Sprite for the ship   
    ...
    public: 
       ...
       // === Public attributes ===
        int health;
        int shield;                         // Needed in public for ease of use and direct access
    ...
    // Main method to draw the playerShip
        ...
        ofImage getSprite2(){return shipSprite2;}
        // ofImage getShieldSprite(){return shieldSprite;}
    /*
    ...
    */
    ...
    // === Input handling ===
        ...
        void upgrade();  // Function that will handle the movement for the ship
